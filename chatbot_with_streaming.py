...
# J'ai juste commenté la partie readline qui ne fonctionne pas sous Windows
# Le code original est ici https://github.com/mistralai/client-python/blob/main/examples/chatbot_with_streaming.py
